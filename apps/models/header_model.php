...
class Header_model extends CI_Model {
	...
	function portfolio_dump() {
		$this->db->select('portfolio_title, portfolio_subtitle, portfolio_url')->from('portfolio')->where('portfolio_live', '1')->where('portfolio_show', '1')->where('portfolio_delete', '0'); // Chained query
