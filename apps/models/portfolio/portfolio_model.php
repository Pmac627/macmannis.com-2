...
class Portfolio_model extends CI_Model {
	...
	function portfolio_dump() {
		$this->db->select('portfolio_id, portfolio_title, portfolio_subtitle, portfolio_url, portfolio_description, portfolio_image, portfolio_image_height')->from('portfolio')->where('portfolio_live', '1')->where('portfolio_show', '1')->where('portfolio_delete', '0'); // Chained query
