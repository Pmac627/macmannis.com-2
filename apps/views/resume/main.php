			...
			<div class="resume-left">
				<article class="resume-item-little">
					<div class="resume-patrick">
						...
						<img class="resume-image" src="<?php echo $CDN_prefix; ?>img/resu-me.jpg" alt="Patrick MacMannis" title="Patrick MacMannis; Web Developer, Dek Hockey Goon &amp; Amateur Ninja." width="230" height="230" />
					</div>
				</article>
				<article class="resume-item-little">
